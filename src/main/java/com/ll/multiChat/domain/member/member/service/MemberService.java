...
import com.ll.multiChat.global.security.SecurityUser;
...
public class MemberService {
    ...
    public RsData<String> refreshAccessToken(String refreshToken){
        Member member = memberRepository.findByRefreshToken(refreshToken).orElseThrow(()-> new IllegalArgumentException("유효하지 않은 토큰"));
