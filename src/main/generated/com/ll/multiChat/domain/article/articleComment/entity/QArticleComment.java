...
public class QArticleComment extends EntityPathBase<ArticleComment> {
    ...
    private static final long serialVersionUID = 869691123L;
    ...
    public final com.ll.multiChat.domain.article.article.entity.QArticle article;
    ...
    public QArticleComment(Class<? extends ArticleComment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.article = inits.isInitialized("article") ? new com.ll.multiChat.domain.article.article.entity.QArticle(forProperty("article"), inits.get("article")) : null;
